    ...
    <div className="container content-page">
      ...
      <div className="intrucciones_de_uso-card p-4 mt-4">
        ...
        <div className="content-center">
          <img src="/assets/dockerlabs/images/instrucciones/1.png" alt="Instrucción 1" />
        ...
        <div className="content-center">
          <img src="/assets/dockerlabs/images/instrucciones/2.png" alt="Instrucción 2" />
        ...
        <img src="/assets/dockerlabs/images/instrucciones/3.png" alt="Instrucción 3" className="content-img" />
        <p>En el caso de una máquina de pivoting nos preguntará lo siguiente:</p>
        <img src="/assets/dockerlabs/images/instrucciones/4.png" alt="Instrucción 4" className="content-img full-width" />
        ...
        <div className="content-center">
          <img src="/assets/dockerlabs/images/instrucciones/5.png" alt="Instrucción 5" className="full-width" />
