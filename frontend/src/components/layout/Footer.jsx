      ...
      <div className="footer-content">
        <div className="footer-left">
          <p className="copyright">
            <i className="bi bi-c-circle" /> Copyright DockerLabs ·{' '}
        ...
        <div className="footer-right">
          <a href="https://www.youtube.com/@ElPinguinoDeMario" className="footer-link" target="_blank" rel="noopener noreferrer">By El Pingüino de Mario 🐧</a>
        </div>
      </div>
