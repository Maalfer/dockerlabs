...
function renderRow(writeup) {
    ...
    const imagen = writeup.imagen ? `/static/images/${writeup.imagen}` : '/static/images/logos/logo.png';
    ...
    tr.innerHTML = `
        <td>
            <div style="width: 40px; height: 40px; border-radius: 8px; background: rgba(255,255,255,0.1); display: flex; align-items: center; justify-content: center; overflow: hidden;">
                <img src="${imagen}" alt="${maquina}" style="width: 100%; height: 100%; object-fit: contain;" onerror="this.src='/static/images/logos/logo.png'">
            </div>
        </td>
